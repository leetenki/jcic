class TradersController < ApplicationController
  ...
  private
  def trader_params
    params.require(:trader).permit(:company_name, :person_name, :telephone, :fax, :email, :qq, :bank, :address, :bank, :password, :account, :password_confirmation, :individual_price, :group_price_indivisual, :group_price_1_10, :group_price_11_20, :group_price_21_30, :group_price_31_40, :year_3_price, :year_5_price, :other_price, :activation)
  end
end
